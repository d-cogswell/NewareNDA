...
### Changed
- Github Actions now includes Python 3.14 regression testing.


## [v2025.12.01]
### Added
- Support for ndc version 16.

### Fixed
- Bug fixes related to duplicate indices, data interpolation, and hardware cycle counter


## [v2025.11.03]
### Added
- Support for ndc 17 aux data (filetype 5).
...
### Changed
- The minimum Pandas version is no longer needed.
